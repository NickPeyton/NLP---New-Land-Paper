...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+tot_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1581",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+tot_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1674",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+avg_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1581",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+avg_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1674",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+max_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1581",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+max_val_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1674",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+count_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1581",
)
...
fit <- tmle(
  ...
  W = W,
  gform = "A~will_share_1536+tot_val_pctile_1524+count_pctile_1524+ln_max_val_1524+ln_parish_avg_value_1524+ln_parish_monastic_land",
  Qform = "Y~A+count_pctile_1524+parish_distmkt+parish_distriver+ln_parish_avg_value_1674",
)
...
tot_xtable = xtable(tot_val_results,
                    ...
                    label = 'tab:tot_val_dr_1524_zeroes',
                    align = 'llll')

write.csv(t(tot_val_results), glue('{TABLES}/tot_val_dr_1524_zeroes.csv'))

print(tot_xtable, 
      type='latex',
      file=glue('{TABLES}/tot_val_dr_1524_zeroes.tex'),
...
avg_xtable = xtable(avg_val_results,
                    ...
                    align = 'llll')
write.csv(t(avg_val_results), glue('{TABLES}/avg_val_dr_1524_zeroes.csv'))
print(avg_xtable, 
      type='latex',
      file=glue('{TABLES}/avg_val_dr_1524_zeroes.tex'),
      include_rownames=TRUE,
      booktabs=TRUE)
...
max_xtable = xtable(max_val_results,
                    ...
                    align = 'llll')
write.csv(t(max_val_results), glue('{TABLES}/max_val_dr_1524_zeroes.csv'))
print(max_xtable, 
      type='latex',
      file=glue('{TABLES}/max_val_dr_1524_zeroes.tex'),
      include_rownames=TRUE,
      booktabs=TRUE)
...
max_xtable = xtable(count_results,
                    ...
                    label = 'tab:count_dr_1524_zeroes',
                    align = 'llll')
write.csv(t(count_results), glue('{TABLES}/count_dr_1524_zeroes.csv'))
print(max_xtable, 
      type='latex',
      file=glue('{TABLES}/count_dr_1524_zeroes.tex'),
      include_rownames=TRUE,
      booktabs=TRUE)